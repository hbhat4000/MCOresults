...
for i in states:
    ...
    for j in T:
        ...
        ts[L] = i-1
        ts_test[j] = i - 1
        _, LTerr_test,_ = test_naiveCTMC(ts,tseq,ts_test,tseq_test,wantST=False)
        _, LTerr_test_fixed,constrviol,_,_,sparsity= test_fixedCTMC(ts,tseq,ts_test,tseq_test,wantST=False)
